          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-gray-900">Enable Auto Bot</h3>
                  <p className="text-sm text-gray-600">Run payer bot nightly at 2:00 AM</p>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                { role: "Analyst", permissions: "Read + Export + Create Appeals", users: "5 users" },
                { role: "Coder", permissions: "Read + Modify Codes", users: "3 users" }
              ].map((roleData, index) => (
                <motion.div
                  key={roleData.role}
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{roleData.permissions}</p>
